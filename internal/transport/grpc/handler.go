...
import (
	...
	rkt "github.com/singfield/grpc-monorepo/rocket/v1"
...
func (h Handler) InsertRocket(ctx context.Context, req *rkt.InsertRocketRequest) (*rkt.InsertRocketResponse, error) {
	return &rkt.InsertRocketResponse{}, nil
}
